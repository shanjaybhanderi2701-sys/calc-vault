...
/**
 * A minimal byte-bounded LRU map for decoded bitmaps/strips (APP-244 cache management, moved into
 * the kit by APP-438).
 *
 ...
 * decodes can run on many IO workers at once.
 *
 ...
 * 1000-item library can never OOM the heap.
 */
